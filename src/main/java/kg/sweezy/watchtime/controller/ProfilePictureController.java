...
public class ProfilePictureController {
    ...
    public ResponseEntity<?> uploadProfilePicture(@RequestPart MultipartFile profilePicture) {
    ...
    public ResponseEntity<?> getProfilePictureByFileName(@RequestParam String fileName) {
